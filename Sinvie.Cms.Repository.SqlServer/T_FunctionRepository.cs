...
{
    public class T_FunctionRepository:BaseRepository<T_Function,Int32>, IT_FunctionRepository
    {
        public T_FunctionRepository(IOptionsSnapshot<DbOption> options)
        {
        ...
        {
            string sql = "update T_Function set IsDelete=1 where Id in @Ids";
