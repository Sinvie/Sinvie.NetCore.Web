...
{
    public class T_ArticleRepository:BaseRepository<T_Article,Int32>, IT_ArticleRepository
    {
        public T_ArticleRepository(IOptionsSnapshot<DbOption> options)
        {
