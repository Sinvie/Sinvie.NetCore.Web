...
{
    public class T_AreaRepository:BaseRepository<T_Area,Int32>, IT_AreaRepository
    {
        public T_AreaRepository(IOptionsSnapshot<DbOption> options)
        {
        ...
        {
            string sql = "update T_Area set IsDelete=1 where Id in @Ids";
