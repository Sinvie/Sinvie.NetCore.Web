...
{
    public class T_ChannelRepository:BaseRepository<T_Channel,Int32>, IT_ChannelRepository
    {
        public T_ChannelRepository(IOptionsSnapshot<DbOption> options)
        {
        ...
        {
            string sql = "update T_Channel set IsDelete=1 where Id in @Ids";
