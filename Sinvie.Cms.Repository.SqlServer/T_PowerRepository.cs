...
{
    public class T_PowerRepository:BaseRepository<T_Power,Int32>, IT_PowerRepository
    {
        public T_PowerRepository(IOptionsSnapshot<DbOption> options)
        {
        ...
        {
            string sql = "update T_Power set IsDelete=1 where Id in @Ids";
