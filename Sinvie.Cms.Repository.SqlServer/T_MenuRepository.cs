...
{
    public class T_MenuRepository:BaseRepository<T_Menu,Int32>, IT_MenuRepository
    {
        public T_MenuRepository(IOptionsSnapshot<DbOption> options)
        {
        ...
        {
            string sql = "update T_Menu set IsDelete=1 where Id in @Ids";
