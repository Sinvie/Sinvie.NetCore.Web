...
{
    public class T_ClassRepository:BaseRepository<T_Class,Int32>, IT_ClassRepository
    {
        public T_ClassRepository(IOptionsSnapshot<DbOption> options)
        {
        ...
        {
            string sql = "update T_Class set IsDelete=1 where Id in @Ids";
